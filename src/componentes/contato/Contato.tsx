  ...
  <div className='container-form'>
   ...
   <li><a><i className="fa-solid fa-phone" style={{color: "#0561ff"}}> </i> Contato por telefone</a></li>
     ...
     <div className='form'>
        ...
        <input type='text' name='name' placeholder='Digite seu nome'onChange={muda_txt}></input>
     
        <input type='email' name='email' placeholder='Digite seu email' onChange={muda_txt}></input>
      
        <input type='text' name='message' placeholder='Assunto'onChange={muda_txt}></input>
